...
unsigned int nStakeMinAge = 6 * nOneHour; //
unsigned int nStakeMaxAge = 1.5 * 24 * nOneHour; // 
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // DIAMOND: check proof-of-stake block signature
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "DIAMOND";
        CTransaction txNew;
        txNew.nTime = 1500105017;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1500105018;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2878298; // !fTestNet ? 1575379 : 46534;
