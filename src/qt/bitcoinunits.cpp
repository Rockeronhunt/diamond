...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("DIAMOND");
    case mBTC: return QString("mDIAMOND");
    case uBTC: return QString::fromUtf8("μDIAMOND");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("DIAMONDs"));
    case mBTC: return QString(QObject::tr("Milli-DIAMONDs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-DIAMONDs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
