DIAMOND-qt: Qt4 GUI for DIAMOND
===============================
...
A warning for people using the *static binary* version of DIAMOND on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of DIAMOND is linked against libdb5.3.
